...
#HotIf WinActive("ahk_exe Ableton Live 12(\s[A-Za-z]*)?.exe ahk_class #32770")
#Include Hotkey.Definitions.ahk

#HotIf WinActive("ahk_exe Ableton Live 12(\s[A-Za-z]*)?.exe ahk_class AbletonVstPlugClass")
F6:: F6HK(ThisHotkey)
#IncludeAgain Hotkey.Definitions.ahk

#HotIf WinActive("ahk_exe Ableton Live 12(\s[A-Za-z]*)?.exe ahk_class Vst3PlugWindow")
F6:: F6HK(ThisHotkey)
#IncludeAgain Hotkey.Definitions.ahk
