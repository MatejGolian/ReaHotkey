...
Class CinematicStudioSeries {
    ...
    Static __New() {
        ...
        CinematicStudioBrassOverlay.AddGraphicalToggleButton("Mix Position", %PluginClass%XOffset + 186, %PluginClass%YOffset + 476, %PluginClass%XOffset + 206, %PluginClass%YOffset + 488, "Images/SampleLibraries/CinematicStudioBrass/MixOn.png", "Images/SampleLibraries/CinematicStudioBrass/MixOff.png")
        ...
        CinematicStudioStringsOverlay.AddGraphicalToggleButton("Mix Position", %PluginClass%XOffset + 188, %PluginClass%YOffset + 473, %PluginClass%XOffset + 220, %PluginClass%YOffset + 489, "Images/SampleLibraries/CinematicStudioStrings/MixOn.png", "Images/SampleLibraries/CinematicStudioStrings/MixOff.png")
