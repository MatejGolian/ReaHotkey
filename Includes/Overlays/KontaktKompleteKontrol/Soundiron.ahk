...
Class Soundiron {
    ...
    Static __New() {
        ...
        MimiPageLightAndShadowOverlay.Metadata := Map("Vendor", "Soundiron", "Product", "Mimi Page Light & Shadow", "Image", Map("File", "Images/SampleLibraries/MimiPageLightAndShadow/Product.png"))
        MimiPageLightAndShadowOverlay.AddPluginOverlay()
        MimiPageLightAndShadowOverlay.AddStaticText("Mimi Page Light & Shadow")
        MimiPageLightAndShadowOverlay.AddGraphicalToggleButton("Reverb", This.%PluginClass%XOffset + 324, This.%PluginClass%YOffset + 462, This.%PluginClass%XOffset + 344, This.%PluginClass%YOffset + 502, "Images/SampleLibraries/MimiPageLightAndShadow/ReverbOn.png", "Images/SampleLibraries/MimiPageLightAndShadow/ReverbOff.png", ObjBindMethod(This, "ClickFXRack"),, ObjBindMethod(This, "ClickFXRack"))
        %PluginClass%.PluginOverlays.Push(MimiPageLightAndShadowOverlay)
        
        VoicesOfGaiaOverlay := PluginOverlay("Voices Of Gaia")
        VoicesOfGaiaOverlay.Metadata := Map("Vendor", "Soundiron", "Product", "Voices Of Gaia", "Image", Map("File", "Images/SampleLibraries/VoicesOfGaia/Product.png"))
        VoicesOfGaiaOverlay.AddPluginOverlay()
        VoicesOfGaiaOverlay.AddStaticText("Voices Of Gaia")
        VoicesOfGaiaOverlay.AddGraphicalToggleButton("Reverb", This.%PluginClass%XOffset + 10, This.%PluginClass%YOffset + 150, This.%PluginClass%XOffset + 30, This.%PluginClass%YOffset + 180, "Images/SampleLibraries/VoicesOfGaia/ReverbOn.png", "Images/SampleLibraries/VoicesOfGaia/ReverbOff.png", ObjBindMethod(This, "ClickFXRack"),, ObjBindMethod(This, "ClickFXRack"))
        %PluginClass%.PluginOverlays.Push(VoicesOfGaiaOverlay)
        
        VoicesOfWindCollectionOverlay := PluginOverlay("Voices of Wind Collection")
        VoicesOfWindCollectionOverlay.Metadata := Map("Vendor", "Soundiron", "Product", "Voices of Wind Collection", "Image", Map("File", "Images/SampleLibraries/VoicesOfWindCollection/Product.png"))
        VoicesOfWindCollectionOverlay.AddPluginOverlay()
        VoicesOfWindCollectionOverlay.AddStaticText("Voices of Wind Collection")
        VoicesOfWindCollectionOverlay.AddGraphicalToggleButton("Reverb", This.%PluginClass%XOffset + 324, This.%PluginClass%YOffset + 462, This.%PluginClass%XOffset + 344, This.%PluginClass%YOffset + 502, "Images/SampleLibraries/VoicesOfWindCollection/ReverbOn.png", "Images/SampleLibraries/VoicesOfWindCollection/ReverbOff.png", ObjBindMethod(This, "ClickFXRack"),, ObjBindMethod(This, "ClickFXRack"))
