...
AreiaOverlay.AddGraphicalButton("Classic Mix", %ClassName%.XOffset + 70, %ClassName%.XOffset + 350, %ClassName%.XOffset + 140, %ClassName%.XOffset + 370, "Images/KontaktKompleteKontrol/Areia/ClassicMixOn.png", ["Images/KontaktKompleteKontrol/Areia/ClassicMixOff1.png", "Images/KontaktKompleteKontrol/Areia/ClassicMixOff2.png"], CompensatePluginRegionCoordinates, CompensatePluginRegionCoordinates)
AreiaOverlay.AddGraphicalButton("Modern Mix", %ClassName%.XOffset + 140, %ClassName%.XOffset + 350, %ClassName%.XOffset + 240, %ClassName%.XOffset + 370, "Images/KontaktKompleteKontrol/Areia/ModernMixOn.png", ["Images/KontaktKompleteKontrol/Areia/ModernMixOff1.png", "Images/KontaktKompleteKontrol/Areia/ModernMixOff2.png"], CompensatePluginRegionCoordinates, CompensatePluginRegionCoordinates)
...
NucleusOverlay.AddGraphicalButton("Classic Mix", %ClassName%.XOffset + 110, %ClassName%.XOffset + 300, %ClassName%.XOffset + 190, %ClassName%.XOffset + 360, "Images/KontaktKompleteKontrol/Nucleus/ClassicMixOn.png", "Images/KontaktKompleteKontrol/Nucleus/ClassicMixOff.png", CompensatePluginRegionCoordinates, CompensatePluginRegionCoordinates)
NucleusOverlay.AddGraphicalButton("Modern Mix", %ClassName%.XOffset + 110, %ClassName%.XOffset + 330, %ClassName%.XOffset + 190, %ClassName%.XOffset + 360, "Images/KontaktKompleteKontrol/Nucleus/ModernMixOn.png", "Images/KontaktKompleteKontrol/Nucleus/ModernMixOff.png", CompensatePluginRegionCoordinates, CompensatePluginRegionCoordinates)
...
TalosOverlay.AddGraphicalButton("Classic Mix", %ClassName%.XOffset + 70, %ClassName%.XOffset + 350, %ClassName%.XOffset + 140, %ClassName%.XOffset + 370, "Images/KontaktKompleteKontrol/Talos/ClassicMixOn.png", ["Images/KontaktKompleteKontrol/Talos/ClassicMixOff1.png", "Images/KontaktKompleteKontrol/Talos/ClassicMixOff2.png"], CompensatePluginRegionCoordinates, CompensatePluginRegionCoordinates)
TalosOverlay.AddGraphicalButton("Modern Mix", %ClassName%.XOffset + 140, %ClassName%.XOffset + 350, %ClassName%.XOffset + 240, %ClassName%.XOffset + 370, "Images/KontaktKompleteKontrol/Talos/ModernMixOn.png", ["Images/KontaktKompleteKontrol/Talos/ModernMixOff1.png", "Images/KontaktKompleteKontrol/Talos/ModernMixOff2.png"], CompensatePluginRegionCoordinates, CompensatePluginRegionCoordinates)
