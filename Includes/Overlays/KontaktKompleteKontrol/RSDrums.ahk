...
Class RSDrums {
    ...
    Static __New() {
        ...
        FairviewOverlay.AddHotspotButton("Snare selector", %PluginClass%XOffset + 476, %PluginClass%YOffset + 454, CompensatePluginPointCoordinates,, CompensatePluginPointCoordinates, Kontakt.OpenPluginMenu)
