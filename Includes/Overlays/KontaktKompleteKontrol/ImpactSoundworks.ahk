...
Class ImpactSoundworks {
    ...
    Static __New() {
        ...
        JuggernautBassOverlay.AddOCRButton("Preset", "Unknown preset", %PluginClass%XOffset + 354, %PluginClass%YOffset + 125, %PluginClass%XOffset + 562, %PluginClass%YOffset + 175,,, CompensatePluginCoordinates,, CompensatePluginCoordinates)
        ...
        JuggernautDrumsAndFXOverlay.AddOCRButton("Preset", "Unknown preset", %PluginClass%XOffset + 150, %PluginClass%YOffset + 132, %PluginClass%XOffset + 360, %PluginClass%YOffset + 170,,, CompensatePluginCoordinates,, CompensatePluginCoordinates)
