...
Class Zampler {
    ...
    Static __New() {
        ...
        MainTab.AddOCRButton("Patch", "Patch not detected", "TesseractBest", 296, 264, 496, 277,,, KompleteKontrol.CompensatePluginCoordinates,, KompleteKontrol.CompensatePluginCoordinates)
        ...
        MainTab.AddHotspotButton("SFZ/REX", 499, 244, [KompleteKontrol.CompensatePluginCoordinates, ObjBindMethod(This, "ResetLabel"), ObjBindMethod(This, "GetSFZREXInstrument")],, [KompleteKontrol.CompensatePluginCoordinates, ObjBindMethod(This, "ResetLabel")])
        ...
        ModMatrixTab := HotspotTab("Mod matrix", 415, 210, KompleteKontrol.CompensatePluginCoordinates)
        ...
        ArpeggiatorTab := HotspotTab("Arpeggiator", 503, 210, KompleteKontrol.CompensatePluginCoordinates)
