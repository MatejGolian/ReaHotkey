...
Class Zampler {
    ...
    Static __New() {
        ...
        FilterBox := ListBox("Filter", "", ObjBindMethod(This, "ChangeFilter"), [ObjBindMethod(This, "MoveToFilter"), ObjBindMethod(This, "GetFilter")])
    ...
    Static InitConfig() {
        ReaHotkey.Config.Add("ReaHotkey.ini", "Config", "ZamplerImageSearch", 1, {Label: "Use image search for Zampler plug-in detection", Tab: "Misc"})
    }
