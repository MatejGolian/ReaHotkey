...
Class Hive2 {
    ...
    Static __New() {
        ...
        Hive2Overlay.AddOCRButton("Preset Menu, currently loaded", "Preset Menu, preset name not detected", "TesseractBest", 560, 12, 720, 32,,, KompleteKontrol.CompensatePluginCoordinates,, KompleteKontrol.CompensatePluginCoordinates).SetHotkey("!M", "Alt+M")
        Hive2Overlay.AddHotspotButton("Next Preset", 756, 28, KompleteKontrol.CompensatePluginCoordinates,, KompleteKontrol.CompensatePluginCoordinates).SetHotkey("!N", "Alt+N")
        Hive2Overlay.AddHotspotButton("Save Preset", 990, 28, KompleteKontrol.CompensatePluginCoordinates,, KompleteKontrol.CompensatePluginCoordinates).SetHotkey("^S", "Ctrl+S")
