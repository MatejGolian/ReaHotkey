...
Class OverlayLoader {
    ...
    "CustomListBox", {RequiredParams: ["Label"], OptionalParams: ["PreExecFocusFunctions", "PostExecFocusFunctions", "ChangeFunctions", "HotkeyCommand", "HotkeyLabel", "HotkeyFunctions"]},
    ...
    "HotspotListBox", {RequiredParams: ["Label", "XCoordinate", "YCoordinate"], OptionalParams: ["PreExecFocusFunctions", "PostExecFocusFunctions", "ChangeFunctions", "HotkeyCommand", "HotkeyLabel", "HotkeyFunctions"]},
    ...
    "ListBox", {RequiredParams: ["Label"], OptionalParams: ["PreExecFocusFunctions", "PostExecFocusFunctions", "ChangeFunctions", "HotkeyCommand", "HotkeyLabel", "HotkeyFunctions"]},
    ...
    "OCRListBox", {RequiredParams: ["Label", "DefaultValue", "OCRType", "X1Coordinate", "Y1Coordinate", "X2Coordinate", "Y2Coordinate"], OptionalParams: ["OCRLanguage", "OCRScale", "PreExecFocusFunctions", "PostExecFocusFunctions", "ChangeFunctions", "HotkeyCommand", "HotkeyLabel", "HotkeyFunctions"]},
