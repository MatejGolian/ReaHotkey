...
Class OverlayLoader {
    ...
    "ComboBox", {RequiredParams: ["Label"], OptionalParams: ["PreExecFocusFunctions", "PostExecFocusFunctions", "ChangeFunctions", "HotkeyCommand", "HotkeyLabel", "HotkeyFunctions"]},
    ...
    "CustomComboBox", {RequiredParams: ["Label"], OptionalParams: ["PreExecFocusFunctions", "PostExecFocusFunctions", "ChangeFunctions", "HotkeyCommand", "HotkeyLabel", "HotkeyFunctions"]},
    ...
    "HotspotComboBox", {RequiredParams: ["Label", "XCoordinate", "YCoordinate"], OptionalParams: ["PreExecFocusFunctions", "PostExecFocusFunctions", "ChangeFunctions", "HotkeyCommand", "HotkeyLabel", "HotkeyFunctions"]},
    ...
    "OCRComboBox", {RequiredParams: ["Label", "DefaultValue", "OCRType", "X1Coordinate", "Y1Coordinate", "X2Coordinate", "Y2Coordinate"], OptionalParams: ["OCRLanguage", "OCRScale", "PreExecFocusFunctions", "PostExecFocusFunctions", "ChangeFunctions", "HotkeyCommand", "HotkeyLabel", "HotkeyFunctions"]},
