...
Class GenericPlugin1 Extends PluginLoader {
    ...
    Static __New() {
        ...
        PluginLoader.AddImageCheck("Generic Plug-in 1", "Engine 2", "Images/Engine2/Engine2.png")
        PluginLoader.AddImageCheck("Generic Plug-in 1", "sforzando", "Images/Sforzando/Sforzando.png")
