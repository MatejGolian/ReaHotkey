...
SynthPresetCtrl := PopulatedListBox("Synth Preset", ObjBindMethod(Dubler2, "FocusListBox"), , ObjBindMethod(Dubler2, "SelectListBoxItem"))
...
KeyCtrl := PopulatedListBox("Key", ObjBindMethod(Dubler2, "FocusListBox"), , ObjBindMethod(Dubler2, "SelectListBoxItem"))
...
ScaleCtrl := PopulatedListBox("Scale", ObjBindMethod(Dubler2, "FocusListBox"), , ObjBindMethod(Dubler2, "SelectListBoxItem"))
