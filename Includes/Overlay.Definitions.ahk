...
EnginePluginAddLibraryButton := EnginePluginLibrariesTab.AddHotspotButton("Add library", 436, 146, [CompensatePluginCoordinates, FocusedEnginePluginAddLibraryButton], CompensatePluginCoordinates)
