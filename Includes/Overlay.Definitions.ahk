...
AreiaOverlay.AddHotspotButton("Classic Mix", 468, 395, CompensatePluginHotspotCoordinates, CompensatePluginHotspotCoordinates)
AreiaOverlay.AddHotspotButton("Modern Mix", 565, 395, CompensatePluginHotspotCoordinates, CompensatePluginHotspotCoordinates)
...
JaegerOverlay.AddHotspotButton("Classic Mix", 468, 395, CompensatePluginHotspotCoordinates, CompensatePluginHotspotCoordinates)
JaegerOverlay.AddHotspotButton("Modern Mix", 565, 395, CompensatePluginHotspotCoordinates, CompensatePluginHotspotCoordinates)
...
NucleusOverlay.AddHotspotButton("Classic Mix", 480, 349, CompensatePluginHotspotCoordinates, CompensatePluginHotspotCoordinates)
NucleusOverlay.AddHotspotButton("Modern Mix", 480, 379, CompensatePluginHotspotCoordinates, CompensatePluginHotspotCoordinates)
...
TalosOverlay.AddHotspotButton("Classic Mix", 468, 395, CompensatePluginHotspotCoordinates, CompensatePluginHotspotCoordinates)
TalosOverlay.AddHotspotButton("Modern Mix", 565, 395, CompensatePluginHotspotCoordinates, CompensatePluginHotspotCoordinates)
...
EnginePluginOverlay.AddHotspotButton("Load instrument", 170, 185, CompensatePluginHotspotCoordinates, CompensatePluginHotspotCoordinates)
EnginePluginQuickEditTab := HotspotTab("Quick edit", 352, 72, CompensatePluginHotspotCoordinates)
EnginePluginProEditTab := HotspotTab("Pro edit", 424, 72, CompensatePluginHotspotCoordinates)
EnginePluginBrowserTab := HotspotTab("Browser", 488, 72, CompensatePluginHotspotCoordinates)
EnginePluginMixerTab := HotspotTab("Mixer", 528, 72, CompensatePluginHotspotCoordinates)
EnginePluginPreferencesTab := HotspotTab("Preferences", 580, 72, CompensatePluginHotspotCoordinates)
EnginePluginHelpTab := HotspotTab("Help", 600, 72, CompensatePluginHotspotCoordinates)
...
EnginePluginEngineTab := HotspotTab("Engine", 396, 112, CompensatePluginHotspotCoordinates)
EnginePluginLibrariesTab := HotspotTab("Libraries", 424, 112, CompensatePluginHotspotCoordinates)
EnginePluginAddLibraryButton := EnginePluginLibrariesTab.AddHotspotButton("Add library", 436, 146, CompensatePluginHotspotCoordinates, [CompensatePluginHotspotCoordinates, ActivateEnginePluginAddLibraryButton])
EnginePluginUserFolderTab := HotspotTab("User folder", 488, 112, CompensatePluginHotspotCoordinates)
EnginePluginOutputSurrTab := HotspotTab("Output/Surr", 572, 112, CompensatePluginHotspotCoordinates)
EnginePluginMiscTab := HotspotTab("Misc.", 656, 112, CompensatePluginHotspotCoordinates)
...
ShreddageOverlay.AddHotspotButton("Guitar Number 1", 842, 471, CompensatePluginHotspotCoordinates, CompensatePluginHotspotCoordinates)
ShreddageOverlay.AddHotspotButton("Guitar Number 2", 866, 471, CompensatePluginHotspotCoordinates, CompensatePluginHotspotCoordinates)
ShreddageOverlay.AddHotspotButton("Guitar Number 3", 890, 471, CompensatePluginHotspotCoordinates, CompensatePluginHotspotCoordinates)
ShreddageOverlay.AddHotspotButton("Guitar Number 4", 914, 471, CompensatePluginHotspotCoordinates, CompensatePluginHotspotCoordinates)
