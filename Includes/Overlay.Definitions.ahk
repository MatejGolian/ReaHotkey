...
EnginePluginOverlay.AddHotspotButton("Load instrument", 112, 180, CompensatePluginClick)
EnginePluginQuickEditTab := HotspotTab("Quick edit", 352, 72, CompensatePluginClick)
EnginePluginProEditTab := HotspotTab("Pro edit", 424, 72, CompensatePluginClick)
EnginePluginBrowserTab := HotspotTab("Browser", 488, 72, CompensatePluginClick)
EnginePluginMixerTab := HotspotTab("Mixer", 528, 72, CompensatePluginClick)
EnginePluginPreferencesTab := HotspotTab("Preferences", 580, 72, CompensatePluginClick)
EnginePluginHelpTab := HotspotTab("Help", 600, 72, CompensatePluginClick)
...
EnginePluginEngineTab := HotspotTab("Engine", 396, 112, CompensatePluginClick)
EnginePluginLibrariesTab := HotspotTab("Libraries", 424, 112, CompensatePluginClick)
...
EnginePluginUserFolderTab := HotspotTab("User folder", 488, 112, CompensatePluginClick)
EnginePluginOutputSurrTab := HotspotTab("Output/Surr", 572, 112, CompensatePluginClick)
EnginePluginMiscTab := HotspotTab("Misc.", 656, 112, CompensatePluginClick)
